create database DB_L24_E_03022023_DependDrpdwn
use DB_L24_E_03022023_DependDrpdwn
...
alter table Registration add  State int
...
alter proc sp_Insert_registration
@name varchar(100),
@age int,
@gender int,
@country int,
